...
function draw() {
  if (pantalla == 0 ) {
    ...
    textSize(14)
      text("Maria Celeste Condoluci", 225, 255);
  ...
  if (pantalla === 6) {
    ...
    dibujarBoton(70, 403, 168, 50, "'Esta solo Stacy y Jeremy'", 100, 428);
    dibujarBoton(400, 403, 168, 50, "'Lo lamento, se descontrolo \ny vino mas gente'", 460, 422);
  }
  ...
  if (pantalla === 10) {
    ...
    dibujarBoton(70, 403, 85, 50, "Los deja tocar", 200, 428);
    dibujarBoton(400, 403, 98, 50, "No los deja tocar", 500, 428);
  }
